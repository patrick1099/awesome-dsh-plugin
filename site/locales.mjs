...
export default [
  {
    ...
    strings: {
      ...
      P_COMMENTS_LOAD: 'Load comments',
      P_COMMENTS_LOADING: 'Loading comments…',
      P_COMMENTS_READY: 'Comments loaded.',
      P_COMMENTS_ERROR: 'Comments could not be loaded. Try again or open GitHub Discussions.',
  ...
  },
  {
    ...
    strings: {
      ...
      P_COMMENTS_LOAD: '加载评论',
      P_COMMENTS_LOADING: '正在加载评论…',
      P_COMMENTS_READY: '评论已加载。',
      P_COMMENTS_ERROR: '评论加载失败。请重试或前往 GitHub Discussions。',
